Automated acceptance tests for buildit

### Requirements

A local instance of https://github.com/buildit/acceptance-testing running in 'test' mode
...
```bash
# to execute all features (all tests)
behave

# run features with specific tags (e.g. all daily tests)
behave --tags=daily
```
